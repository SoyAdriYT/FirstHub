...
-- Hashing
local hasher = not isStudio and loadstring(game:HttpGet("https://raw.githubusercontent.com/SoyAdriYT/FirstHub/refs/heads/main/FirstHubUI/FirstAPI.lua"))()["hasher"] --or require(script.Parent.ModuleScript)['hasher']
