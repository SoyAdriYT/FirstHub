...
local function getIcon(name : string)
	...
	local iconData = not useStudio and game:HttpGet('https://raw.githubusercontent.com/SoyAdriYT/FirstHub/refs/heads/main/FirstHubUI/Icons.lua')
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "First AI"
	end
		...
		task.spawn(function()
			while true do
				...
				RayfieldLibrary:Notify({
					Title = "FirstHub",
					Content = "Are you enjoying FirstHub join our discord: https://discord.gg/yZTduXkhMn",
					Duration = 7,
					Image = 4370033185,
				})
			end
...
if not useStudio then
	local success, result = pcall(function()
		loadstring(game:HttpGet('https://raw.githubusercontent.com/SoyAdriYT/FirstHub/refs/heads/main/FirstHubUI/FirstBoost.lua'))()
	end)
